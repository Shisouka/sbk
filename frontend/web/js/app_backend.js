/**
 * Created by programmer on 30.09.2015.
 */
/*$.ready(function(){
    $.material.init();
});*/
...
$(document).ready(function() {
    ...
    $("#adm_csortlbl").on("click",function(){
        if($("#adm_csorttbl").is(":visible")){
            $("#adm_csorttbl").css("display","none");
        } else{
            $("#adm_csorttbl").css("display","table");
        }
    })
